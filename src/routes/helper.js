...
const getTags = async (maxTags) => { if(!maxTags) maxTags = 15; let timeNow = new Date().getTime(); let postsTime = timeNow - 14400000; let tagsAPI = await axios.get(api_url+`/trending?after=${postsTime}&limit=100`); let posts = tagsAPI.data; let tags = {};
